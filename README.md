...
**Planned (not yet implemented):** `@statewavedev/connectors-freshdesk`, `-notion`, `-gmail`. These remain `private:true` until each one ships real code — see [docs/roadmap.md](docs/roadmap.md).
